...
public enum ServerErrorCode implements ErrorCode {
	...
	MEDIA_SELECTION_INVALID_WATCAHBLE_TYPE(204),
	MEDIA_SESSION_EXPIRED(205),
	MEDIA_SESSION_CREATION_EXPIRED(206),
	MEDIA_SESSION_EDITION_EXPIRED(207);
	
	private Integer statusCode;
	
	private ServerErrorCode(Integer statusCode) {
