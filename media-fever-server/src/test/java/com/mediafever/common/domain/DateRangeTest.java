package com.mediafever.common.domain;
...
public class DateRangeTest {
	...
	public Iterator<Object[]> getForIsBiggerThan() {
		...
		cases.add(new Object[] { DateUtils.createDate(2009, Calendar.JANUARY, 10),
				DateUtils.createDate(2009, Calendar.JANUARY, 12), DateUtils.createDate(2009, Calendar.JANUARY, 10),
				DateUtils.createDate(2009, Calendar.JANUARY, 12), true });
		cases.add(new Object[] { DateUtils.createDate(2009, Calendar.JANUARY, 10),
				DateUtils.createDate(2009, Calendar.JANUARY, 12), DateUtils.createDate(2009, Calendar.JANUARY, 9),
				DateUtils.createDate(2009, Calendar.JANUARY, 12), true });
		cases.add(new Object[] { DateUtils.createDate(2009, Calendar.JANUARY, 10),
				DateUtils.createDate(2009, Calendar.JANUARY, 12), DateUtils.createDate(2009, Calendar.JANUARY, 10),
				DateUtils.createDate(2009, Calendar.JANUARY, 13), true });
		cases.add(new Object[] { DateUtils.createDate(2009, Calendar.JANUARY, 10),
				DateUtils.createDate(2009, Calendar.JANUARY, 12), DateUtils.createDate(2009, Calendar.JANUARY, 9),
				DateUtils.createDate(2009, Calendar.JANUARY, 13), true });
		cases.add(new Object[] { DateUtils.createDate(2009, Calendar.JANUARY, 10),
				DateUtils.createDate(2009, Calendar.JANUARY, 12), DateUtils.createDate(2009, Calendar.JANUARY, 11),
				DateUtils.createDate(2009, Calendar.JANUARY, 12), false });
		cases.add(new Object[] { DateUtils.createDate(2009, Calendar.JANUARY, 10),
				DateUtils.createDate(2009, Calendar.JANUARY, 12), DateUtils.createDate(2009, Calendar.JANUARY, 10),
				DateUtils.createDate(2009, Calendar.JANUARY, 11), false });
		cases.add(new Object[] { DateUtils.createDate(2009, Calendar.JANUARY, 10),
				DateUtils.createDate(2009, Calendar.JANUARY, 12), DateUtils.createDate(2009, Calendar.JANUARY, 11),
				DateUtils.createDate(2009, Calendar.JANUARY, 11), false });
		cases.add(new Object[] { DateUtils.createDate(2009, Calendar.JANUARY, 10),
				DateUtils.createDate(2009, Calendar.JANUARY, 12), DateUtils.createDate(2009, Calendar.JANUARY, 8),
				DateUtils.createDate(2009, Calendar.JANUARY, 9), false });
	...
	public Iterator<Object[]> overlapsDataProvider() {
		List<Object[]> cases = Lists.newArrayList();
		Date firstOfJan = DateUtils.createDate(2010, Calendar.JANUARY, 1);
		Date tenthOfJan = DateUtils.createDate(2010, Calendar.JANUARY, 10);
		Date twentiethOfJan = DateUtils.createDate(2010, Calendar.JANUARY, 20);
		Date lastOfJan = DateUtils.createDate(2010, Calendar.JANUARY, 31);
	...
	public Iterator<Object[]> intersectionDataProvider() {
		...
		Date firstOfJan = DateUtils.createDate(2010, Calendar.JANUARY, 1);
		Date tenthOfJan = DateUtils.createDate(2010, Calendar.JANUARY, 10);
		Date twentiethOfJan = DateUtils.createDate(2010, Calendar.JANUARY, 10);
		Date lastOfJan = DateUtils.createDate(2010, Calendar.JANUARY, 31);
	...
	public void intersectionExceptionTest() {
		...
		DateRange toTruncate = new DateRange(DateUtils.createDate(2010, Calendar.JANUARY, 1), DateUtils.createDate(
			2010, Calendar.JANUARY, 31));
		DateRange limit = new DateRange(DateUtils.createDate(2010, Calendar.FEBRUARY, 1), DateUtils.createDate(2010,
