 ...
 * @author Maxi Rosson
 */
public class SuggestionsUseCase extends AbstractApiUseCase<APIService> {
	...
	@Inject
	public SuggestionsUseCase(APIService apiService) {
		super(apiService);
	...
	protected void doExecute() {
		watchables = getApiService().searchSuggestions(userId, watchableTypes).getResults();
	}
