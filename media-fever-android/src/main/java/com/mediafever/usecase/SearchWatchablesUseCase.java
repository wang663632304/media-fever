 ...
 * @author Maxi Rosson
 */
public class SearchWatchablesUseCase extends AbstractApiUseCase<APIService> {
	...
	@Inject
	public SearchWatchablesUseCase(APIService apiService) {
		super(apiService);
	...
	protected void doExecute() {
		if (StringUtils.isNotEmpty(query)) {
			watchables = getApiService().searchWatchables(query, watchableTypes).getResults();
		} else {
