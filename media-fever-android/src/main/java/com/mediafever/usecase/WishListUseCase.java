 ...
 * @author Maxi Rosson
 */
public class WishListUseCase extends AbstractApiUseCase<APIService> {
	...
	@Inject
	public WishListUseCase(APIService apiService) {
		super(apiService);
	...
	protected void doExecute() {
		watchables = getApiService().searchWishList(userId, watchableTypes).getResults();
	}
